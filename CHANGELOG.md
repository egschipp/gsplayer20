...
## [4.0.0](https://github.com/egschipp/gsplayer20/compare/v3.0.33...v4.0.0) (2026-08-14)

### Breaking changes

- migrate Spotify integration to the February 2026 Web API contract
- require encrypted OAuth token storage and stronger authentication secrets
- require explicit administrator Spotify IDs for operational endpoints

### Features

- add account-data deletion, token-key rotation, retention, and verified backups
- add versioned database migrations and refresh-token expiry handling
- add production accessibility tests and expanded unit/integration coverage

### Security and operations

- harden CSP, CSRF, SSRF, redirects, logging, Docker, and deployment permissions
- add CodeQL, Dependabot, SBOM, provenance, and pre-promotion vulnerability scans
- update production dependencies and resolve all reported npm vulnerabilities
