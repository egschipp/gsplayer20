...
FROM node:26-bookworm-slim@sha256:cd565714d4da3e84bfd341e31448f81d47c6362198f152345297c9c1154e6341 AS runner
# runtime image
WORKDIR /app
...
COPY --chown=node:node --from=builder /app/worker ./worker
